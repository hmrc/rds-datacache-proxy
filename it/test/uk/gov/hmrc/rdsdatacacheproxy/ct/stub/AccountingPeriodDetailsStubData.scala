...
trait AccountingPeriodDetailsStubData {
  ...
  val aPBalancedItemDefault = APBalancedItem(
    ...
    lpiCalcFlag = Some("N"),
    crDbCalcFlag = Some("Y"),
    creditInterestAmount = Some(BigDecimal(191.7891)),
    debitInterestAmount = Some(BigDecimal(191.7891)),
    latePaymentInterestAmount = Some(BigDecimal(191.7891)),
    repaymentInterestAmount = Some(BigDecimal(191.7891)),
    amountDueForAp = Some(BigDecimal(191.7891))
  )
