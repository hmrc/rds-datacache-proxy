...
object AdministrativeRuleStubData {
  ...
  def getAdminRule(adminRule: String): AdminRule = {
    adminRule match {
      case "START-OF-CTSA"   => adminRuleWithAllFields
      case "INST-PERIOD"     => adminRuleWithEmptyFields
      case "INST-REV-PER-D"  => adminRuleWithoutRuleDate
      case "LAST-INST-PER-M" => adminRuleWithoutRuleNumber
      case "123"             => throw new RuntimeException("Boom")
    }
  }
