...
object AssessmentsInAbsenceStubData {

  def getAssessmentsWithoutReturnData(regNumber: String, paginationStart: Int = 1, paginationMaxRows: Int = 10): AssessmentsInAbsence =
    regNumber match {
      case "XYZ00000000000" =>
