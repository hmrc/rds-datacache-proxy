...
class AssessmentsInAbsenceControllerISpec extends AnyWordSpec with Matchers with ScalaFutures with IntegrationPatience with ApplicationWithWiremock {
  ...
  override lazy val app: Application =
    new GuiceApplicationBuilder()
      ...
      .overrides(
        bind[AssessmentsInAbsenceDataSource].toInstance(new AssessmentsInAbsenceRdsStub)
      )
      .build()
  ...
  "GET /gambling/assessments-without-returns (stubbed repo, no DB)" should {
    ...
    "return 200 with correct AssessmentsInAbsenceData" in {
      AuthStub.authorised()
      ...
      response.json.as[AssessmentsInAbsence] mustBe getAssessmentsWithoutReturnData("XYZ00000000000")
    }
    ...
    "return 200 with correct AssessmentsWithoutReturnData when pageNo & pageSize NOT provided" in {
      ...
      response.json.as[AssessmentsInAbsence] mustBe getAssessmentsWithoutReturnData("XYZ99999999999")
    }
    ...
    "normalise lowercase input" in {
      ...
      response.status mustBe OK
      response.json.as[AssessmentsInAbsence] mustBe getAssessmentsWithoutReturnData("XYZ00000000012")
    }
