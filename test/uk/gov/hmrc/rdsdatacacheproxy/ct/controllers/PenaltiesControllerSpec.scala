...
import uk.gov.hmrc.rdsdatacacheproxy.ct.repositories.PenaltiesDatacacheRepositoryImpl
...
class PenaltiesControllerSpec extends SpecBase with MockitoSugar {
  ...
  private class SetUp {
    val mockCorporationTaxDatacacheRepository: PenaltiesDatacacheRepositoryImpl = mock[PenaltiesDatacacheRepositoryImpl]
    val controller: PenaltiesController = new PenaltiesController(fakeAuthAction, mockCorporationTaxDatacacheRepository, cc)
