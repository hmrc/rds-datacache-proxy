...
class CorporationTaxDatacacheRepositorySpec extends AnyFlatSpec with Matchers with BeforeAndAfter {

  var db: Database = _
  var repository: CorporationTaxDatacacheRepositoryImpl = _
  ...
  before {
    ...
    repository = new CorporationTaxDatacacheRepositoryImpl(db)
  }
