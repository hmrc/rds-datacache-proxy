...
final class SubmittedReturnSingleServiceSpec extends SpecBase {

  private val repository = mock[SubmittedReturnSingleDataSource]
  private val service = new SubmittedReturnSingleService(repository)
