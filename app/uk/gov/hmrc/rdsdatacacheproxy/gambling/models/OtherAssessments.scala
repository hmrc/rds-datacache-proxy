...
final case class OtherAssessments(
  periodStartDate: Option[LocalDate],
  periodEndDate: Option[LocalDate],
  total: Option[BigDecimal],
  totalPeriodRecords: Option[Int],
  assessments: Seq[Assessments]
)

object OtherAssessments {
  implicit val format: OFormat[OtherAssessments] = Json.format[OtherAssessments]
}
