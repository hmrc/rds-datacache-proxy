...
import uk.gov.hmrc.rdsdatacacheproxy.models.responses.{DDIReference, DDPaymentPlans, EarliestPaymentDate, PaymentPlanDetails, UserDebits}
...
class DirectDebitService @Inject()(rdsDatacache: RdsDataSource) extends Logging:
  ...
  def getPaymentPlanDetails(directDebitReference: String, credId: String, paymentReference: String):
  Future[PaymentPlanDetails] =
    rdsDatacache.getPaymentPlanDetails(directDebitReference, credId, paymentReference)
